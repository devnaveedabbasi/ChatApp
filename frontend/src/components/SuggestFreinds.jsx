...
export default function SuggestFriends() {
  ...
  const { isAllSuggestedFirends, allSuggestedFriends, removeSuggestedFriend ,IssendRequestLoading,sendRequest,isAllSuggestedFirendsLoading,cancelRequest} = useFriendStore();
...
<><div className=" grid md:grid-cols-2 grid-cols-1 justify-center items-start gap-4 p-6 overflow-y-auto h-screen !w-full">
